...
class Network(object):
    ...
    def add_node(self, n_id, label=None, shape="dot", damage=0, reproducibility=0 ,exploitability=0, affected_users=0, discoverability=0, **options):
        """
        ...
        if n_id not in self.node_ids:
            n = Node(n_id, shape, damage, reproducibility, exploitability, affected_users, discoverability, label=node_label, font_color=self.font_color, **options)
